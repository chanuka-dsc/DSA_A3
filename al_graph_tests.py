...
def test_ALGraph():
    ...
    # Checks if duplicated edges are being added
    ...
    g.add_edge(3, 2)
    g.remove_node(1)
    # Checks if nodes are removed as expected
    assert (
